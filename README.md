...
Hiiiiiiiiii there , I made a 2D Graphics as given as Advaanced C programming Mini project in my college
This is a simple command-line program built in C that lets you draw basic geometric shapes like lines, rectangles, triangles, and circles directly inside the terminal window.
